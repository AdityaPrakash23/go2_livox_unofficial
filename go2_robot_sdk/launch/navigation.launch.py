...
def generate_launch_description():
    ...
    launch_args = [
        ...
        DeclareLaunchArgument('fast_lio_position_deadband', default_value='0.003', description='Suppress smaller FAST-LIO x/y odom jitter in meters'),
        DeclareLaunchArgument('fast_lio_yaw_deadband', default_value='0.003', description='Suppress smaller FAST-LIO yaw jitter in radians'),
        DeclareLaunchArgument('fast_lio_smoothing_alpha', default_value='0.35', description='FAST-LIO odom smoothing factor, 1.0 disables smoothing'),
        DeclareLaunchArgument('fast_lio_max_position_jump', default_value='0.50', description='Ignore single FAST-LIO position jumps larger than this in meters; <=0 disables'),
        DeclareLaunchArgument('fast_lio_max_yaw_jump', default_value='1.0', description='Ignore single FAST-LIO yaw jumps larger than this in radians; <=0 disables'),
